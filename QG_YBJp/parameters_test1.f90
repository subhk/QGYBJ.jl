MODULE parameters
   ...
   !Free parameters: resolution, number of processors and domain size!
    ...
    integer, parameter :: stratification = constant_N            !For other stratification profiles, update init_base_state routine in init.f90
    ...
    real, parameter :: psi_every_XIP = 1.                                                 !Dump psi every 'psi_every_XIP' inertial period
    real, parameter :: la_every_XIP  = 1.                                                 !Dump L+A every 'la_every_XIP'  inertial period
